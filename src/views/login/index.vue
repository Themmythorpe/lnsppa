  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on"
      ...
      <div class="title-container">
        <img src="https://iili.io/2Iksu3u.jpg" alt="" class="d-block fit-content mx-auto mb-4" style="width: 250px !important;">
      ...
      <el-tooltip v-model="capsTooltip" content="Caps lock is On" placement="right" manual>
        <el-form-item prop="password">
          ...
          <el-input :key="passwordType" ref="password" v-model="loginForm.password" :type="passwordType"
            ...
            @blur="capsTooltip = false" @keyup.enter.native="handleLogin" class="input_el login_input" />
      ...
      <div style=" width: 100%;">
        <div class="tips mb-4" style="float: right;" @click="forgotPassword()">
          <a class="text-white"><span class="me-0 mr-0">Forgot Password?</span></a>
        </div>
      </div>
    ...
    <!-- <div style=" width: 100%;" class="pt-3">
      <div class="tips" style="display: flex;justify-content: center;align-items: center; width: 100%;">
        ...
        <a class="text-white" @click="$router.push('register')"><span>Create an Account</span></a>
      </div>
    </div> -->
    <div style=" width: 100%;" class="pt-2">
      <div class="tips"
        style="display: flex;justify-content: center;align-items: center; width: 100%;text-align: center;">
        <!-- <a class="text-primary" @click="forgotPassword()"><span>Forget Password</span></a> -->
        <!-- <a class="text-primary" @click="$router.push('search-domains')"><span>
            << Go Home</span></a> -->
      </div>
    </div>
