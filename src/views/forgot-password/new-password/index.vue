        ...
        >
          ...
          <div class="bio-data mb-2">
            <el-form-item>
              ...
              <div class="mt-3">Your new password must be different from previously used passwords</div>
            </el-form-item>
          ...
          <div style=" width: 100%;" class="pb-0">
            ...
            >
              <a class="text-primary" href="#"><span>Back to login</span></a>
            </div>
          </div>
        </el-form>
      </el-col>
