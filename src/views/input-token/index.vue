<template>
  <div class="input-token">
    <el-row :gutter="20">
      <el-col>
        <el-form :model="registerForm" :rules="registerRules" class="reset-password" autocomplete="on"
          label-position="left">
          ...
          <div class="bio-data mb-2">
            ...
            <el-form-item label="Input Token">

              <!-- <label for="email" class="py-0">Input Token</label><br> -->
              <el-input ref="token" v-model="resetPassword.token" class="col-12 pt-0" name="" type="number"
                tabindex="1" />
          ...
          <el-button :loading="loading" type="primary" class="py-3 mt-3" style="width:100%;margin-bottom:30px;"
            @click="newPassword()">Send Token</el-button>
